...
public class Boesenbergia_rotunda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boesenbergia_rotunda);

        myback = findViewById(R.id.backrotundaBT);
